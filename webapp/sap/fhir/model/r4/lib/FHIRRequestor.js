...
sap.ui.define([
   ...
   * @param {object} oDefaultQueryParams The default query parameters to be passed on resource type specific requests and not resource instance specific requests (e.g /Patient?_total:accurate&_format:json). It should be of type key:value pairs. e.g.
{'_to+
tal':'accurate'} -> http://hl7.org/fhir/http.html#parameters
  ...
  FHIRRequestor.prototype._sendRequest = function(sMethod, sPath, mParameters, mHeaders, oPayload, fnSuccess, fnError, oBinding) {
    ...
    if (this._isRequestTransformable(sMethod, oFHIRUrl)) {
      ...
      sRequestUrl = sPath.startsWith("http") ? sPath : this._sServiceUrl + oFHIRUrl.getRelativeUrlWithQueryParameters() + sQueryParameter;
              ...
              sRequestUrl = sRequestUrl.replace(/\?sap-client=\d+/, "");
