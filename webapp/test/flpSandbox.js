		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UMM Trinkproto",
									"targetURL": "#ummtrinkprotokollui5trinkprotokoll-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ummtrinkprotokollui5trinkprotokoll-display": {
								"semanticObject": "ummtrinkprotokollui5trinkprotokoll",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ummtrinkprotokoll.ui5trinkprotokoll",
									"url": sap.ui.require.toUrl("ummtrinkprotokoll/ui5trinkprotokoll")
								}
							}
						}
					}
