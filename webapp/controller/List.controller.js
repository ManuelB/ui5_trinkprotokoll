sap.ui.define([
    ...
    return BaseController.extend("ummtrinkprotokoll.ui5trinkprotokoll.controller.List", {
        ...
        onInit : function () {
            ...
            oList.attachEventOnce("requestCompleted", function(){
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("CategoryID", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "ummtrinkprotokoll.ui5trinkprotokoll.view.ViewSettingsDialog",
                    controller: this
